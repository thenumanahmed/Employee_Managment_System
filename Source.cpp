...
char displayMenu()
{
    ...
    do
    {
        ...
        if (choice != '1' && choice != '2' && choice != '3' && choice != '4') {
            cout << "Invalid choice entered by user!\n";
        }
...
void readDataFromFile() {
    ...
    index = 0;                //every time it read the file from start
    while (!File.eof())
    {
...
void takingInputAndManageSalary()
{
    ...
    do {
        ...
        for (int j = 0; j < index; j++) {                //comparing with existing ids
            if (tempid == employee[j].id) {
                checkMatch = true;                      //to check the id was matched or not after ending of the for loop
                cout << endl << "Name :" << employee[j].name;
                cout << endl << "Designation: " << employee[j].designation;
                cout << endl << "Basic Salary: " << employee[j].basicSalary;
                tempMonth = inputMonth();
                if (tempMonth == employee[j].month) {
                    cout << endl << "Enter No of leaves taken by the employee: ";
                    ...
                    cout << endl << "Enter number of leaves taken by the employee: ";
...
void inputDataOfNewEmployee()                  //input new employee data >>>>CASE 3
{
    ...
    cin >> tempfirst;
    cout << endl << "Enter the last name of Employee: ";
    cin >> tempsecond;
    ...
    cout << endl << "Enter the number of leaves: ";
    cin >> employee[index].noOfLeaves;
    cout << endl << "Enter the no of leaves allowed to the Employee: ";
    cin >> employee[index].leavesAllowed;
    cout << endl << "Enter per leave deduction rate: ";
